...
export default function Fans({navigation}) {
  return (
    ...
    <View style={style.container}>
      ...
      >
        <ImageBackground
          ...
          style={style.cover}
        >
          <View style={style.coverDetailTop}>
            <FontAwesome name="camera" size={19} color="white" />
      ...
      >
        <ImageBackground
          source={require("../assets/LiveCover/cover11.jpg")}
          style={style.cover}
        >
          <View style={style.coverDetailTop}>
    ...
    <View style={style.container}>
      ...
      >
        <ImageBackground
          source={require("../assets/LiveCover/cover8.jpg")}
          style={style.cover}
        >
          <View style={style.coverDetailTop}>
            <FontAwesome name="music" size={19} color="white" />
    ...
    <View style={style.container}>
      ...
      >
        ...
        >
          <View style={style.coverDetailTop}>
            <FontAwesome5 name="smile" size={19} color="white" />
    ...
    <View style={style.container}>
      ...
      >
        <ImageBackground
          source={require("../assets/LiveCover/cover12.jpg")}
          style={style.cover}
        >
          <View style={style.coverDetailTop}>
            <FontAwesome name="camera" size={19} color="white" />
    ...
    <View style={style.container}>
      ...
      >
        <ImageBackground
          source={require("../assets/LiveCover/cover4.jpg")}
          style={style.cover}
        >
          <View style={style.coverDetailTop}>
            <FontAwesome5 name="smile" size={19} color="white" />
